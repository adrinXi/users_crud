...
const UserCard = ({user, deleteUserById, setUpdateInfo, setFormIsClose}) => {
    ...
    const handleEdit = () => {
        setUpdateInfo(user)
        setFormIsClose(false) /*importamos la funcion para abrir el formulario desde el edit*/
    }
    ...
    return (
        <article className='user'>
            ...
            <ul className='user__list'>
                <li className='user__item'><span className='user__span'>E-mail: </span>{user.email}</li>
                <li className='user__item'><span className='user__span'>Birthday: </span>
                <div className='user__container-item'>
